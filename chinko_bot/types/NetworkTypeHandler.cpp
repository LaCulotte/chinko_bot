...
NetworkTypeHandler::NetworkTypeHandler() {
    ...
    id_to_builder[ObjectItemQuantity::typeId]                   = make_shared<ObjectItemQuantity>;
	...
	id_to_builder[SkillActionDescription::typeId]			= make_shared<SkillActionDescription>;
	id_to_builder[SkillActionDescriptionTimed::typeId]		= make_shared<SkillActionDescriptionTimed>;
	id_to_builder[SkillActionDescriptionCollect::typeId]	= make_shared<SkillActionDescriptionCollect>;
	id_to_builder[SkillActionDescriptionCraft::typeId]		= make_shared<SkillActionDescriptionCraft>;
    ...
    id_to_builder[FightResultAdditionalData::typeId]        	= make_shared<FightResultAdditionalData>;
    id_to_builder[FightResultExperienceData::typeId]        	= make_shared<FightResultExperienceData>;
    id_to_builder[FightResultListEntry::typeId]     			= make_shared<FightResultListEntry>;
    id_to_builder[FightLoot::typeId]        					= make_shared<FightLoot>;
    id_to_builder[NamedPartyTeam::typeId]   					= make_shared<NamedPartyTeam>;
    id_to_builder[FightResultFighterListEntry::typeId]      	= make_shared<FightResultFighterListEntry>;
    id_to_builder[FightResultTaxCollectorListEntry::typeId] 	= make_shared<FightResultTaxCollectorListEntry>;
    id_to_builder[FightResultPlayerListEntry::typeId]       	= make_shared<FightResultPlayerListEntry>;
    id_to_builder[FightResultMutantListEntry::typeId]       	= make_shared<FightResultMutantListEntry>;
    id_to_builder[NamedPartyTeamWithOutcome::typeId]        	= make_shared<NamedPartyTeamWithOutcome>;
    id_to_builder[FightResultPvpData::typeId]       			= make_shared<FightResultPvpData>;
