#ifndef JOBEXPERIENCEMULTIUPDATE_MESSAGE_H
#define JOBEXPERIENCEMULTIUPDATE_MESSAGE_H
...
public: 
	...
	static const unsigned int protocolId = 5809;
	...
	vector<JobExperience> experiencesUpdates;
