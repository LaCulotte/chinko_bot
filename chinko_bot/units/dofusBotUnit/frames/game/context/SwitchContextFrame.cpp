...
bool SwitchContextFrame::computeMessage(sp<Message> message, int srcId) {
    ...
    case GameContextCreateMessage::protocolId:
        ...
        if(gccMsg->context == GameContextEnum::Roleplay) {
            ...
            // À voir si utile
            // dofusBotParent->mapInfos = make_shared<RoleplayMapManager>();
...
// bool SwitchContextFrame::sendGameMapMovementConfirmMessage(){
...
// bool SwitchContextFrame::sendMapInformationsRequestMessage(double mapId){
